...
public class QualcommSharedRIL extends RIL implements CommandsInterface {
    ...
    processSolicited (Parcel p) {
        ...
        if (rr == null) {
            Log.w(RILJ_LOG_TAG, "Unexpected solicited response! sn: "
                            + serial + " error: " + error);
            return null;
        }
 ...
 | sed -re 's/\{([^,]+),[^,]+,([^}]+).+/case \1: ret = \2(p); break;/'
            ...
            //break;
                ...
                Log.w(RILJ_LOG_TAG, rr.serialString() + "< "
                        + requestToString(rr.mRequest)
            ...
            switch (paramMessage.what) {
                ...
                case EVENT_GET_ICC_STATUS_DONE:
                    ...
                    if (asyncResult.exception != null) {
                        Log.e (RILJ_LOG_TAG, "IccCardStatusDone shouldn't return exceptions!", asyncResult.exception);
                        break;
                    }
                            ...
                            case APPSTATE_PUK:
                                switch (app_type) {
                                    ...
                                    case APPTYPE_RUIM:
                                        ...
                                        break;
                                    default:
                                        Log.e(RILJ_LOG_TAG, "Currently we don't handle SIMs of type: " + app_type);
                                        return;
                                }
                                break;
                            case APPSTATE_READY:
                ...
                default:
                    Log.e(RILJ_LOG_TAG, " Unknown Event " + paramMessage.what);
                    break;
            }
        }
